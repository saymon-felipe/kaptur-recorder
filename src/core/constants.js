(function () {
    /**
     * KapturConstants - Configurações globais e imutáveis da extensão.
     */
    window.KapturConstants = {
        
        APP: {
            NAME: "Kaptur Recorder",
            FOLDER_NAME_DRIVE: "Kaptur Recorder"
        },

        UI: {
            Z_INDEX_HOST: 2147483647, 
            HOST_ID: "kaptur-recorder-host",
            CONTROLS_ID: "kaptur-recorder-controls",
            WEBCAM_PREVIEW_ID: "kaptur-recorder-webcam-preview", // PIP (Pequeno)
            LARGE_PREVIEW_ID: "kaptur-recorder-large-preview",   // Espelho (Grande)
