...
class PlaybackManager {
     ...
     */
    init() {
        console.log("Kaptur Playback: Inicializando receptor...");
     ...
     */
    _handleTrack(event) {
        console.log("Kaptur Playback: Áudio recebido.");
    ...
    async _handleMessage(msg) {
        try {
            ...
            console.error("Kaptur Playback: Erro na mensagem", msg.action, error);
        }
    }
    ...
    async _handleOffer(offer) {
        ...
        console.log("Kaptur Playback: Definindo Remote Description...");
        ...
        if (this.pc.signalingState === "have-remote-offer") {
            console.log("Kaptur Playback: Criando Answer...");
